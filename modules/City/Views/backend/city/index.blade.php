                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="text-input">{{ trans("City name") }}</label>
                        ...
                        @foreach($data as $item)
                            <tr>
                                ...
                                <td class="link-action">
                                    <a href="{{ route('get.city.update', $item->id) }}" class="btn btn-primary" data-toggle="modal" data-target="#form-modal" data-title="{{ trans("Update City") }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <a href="{{ route('get.city.delete', $item->id) }}" class="btn btn-danger btn-delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
