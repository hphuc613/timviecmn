...
Route::prefix("admin")->group(function () {
    Route::prefix("contact_recruitment")->group(function () {
        Route::get("/", "ContactRecruitmentController@index")
             ->name("get.contact_recruitment.list")
             ->middleware('can:contact_recruitment');
        ...
        Route::middleware('can:contact_recruitment-update')->group(function () {
            Route::get("/update/{id}", "ContactRecruitmentController@getUpdate")
                 ->name("get.contact_recruitment.update");
            Route::post("/update/{id}", "ContactRecruitmentController@postUpdate")
                 ->name("post.contact_recruitment.update");
        });
        Route::get("/delete/{id}", "ContactRecruitmentController@delete")
             ->name("get.contact_recruitment.delete")
             ->middleware('can:contact_recruitment-delete');
    });
});
